...
Электронный журнал создан в Python с применением библиотеки Tkinter и СУБД SQLit. Он может использоваться для полевого документирования и поддерживает возможность поиска, редактирования и удаления информации. Создан в Python с применением библиотеки Tkinter и СУБД SQLite.
